...
const About = () => {
  const one = (
    <p>
      I am a <b>Full-Stack Developer & Software Engineer</b> pursuing my <b>Master of Computer Applications (MCA)</b> at Dr. S.N.S. Rajalakshmi College of Arts and Science, Coimbatore. I hold a B.Sc in Computer Science from Jamal Mohamed College, Trichy.
    </p>
  );
  const two = (
    <p>
